        ...
        <>
            ...
            <Main className="secao-padrao">
                ...
                <div className="subtitle">
                    ...
                    <p>Você pode doar alimentos, roupas e materiais de higiene! O ponto de entrega é no 
                        <br/>  R. Mal. Floriano Peixoto, 443 - Jardim Berlim, Jaguariúna - SP, 13820-000</p>
                </div>
                ...
                <div className="donation">
                    <div>
                        ...
                        <h4>BANCO</h4>
                        <p>utilize o contato do banco para 
                        <br/>fazer uma doação</p>
