    ...
    <>
      ...
      <Main className="secao-padrao">
        <div className="introducao-sobre">
          ...
          <p>
            Organização localizada na cidade de Jaguariúna dedicada a oferecer
            atendimento e acolhimento para homens, mulheres e famílias que se
            encontram em situação de vulnerabilidade social ou risco.
          </p>
      ...
      <Section>
        <div className="conteudo">
          <div className="compromissos">
            ...
            <p>
              Alguns dos nossos compromissos para atender às necessidades dos
              indivíduos e famílias em situação de vulnerabilidade, incluindo:
            </p>
          ...
          <div className="localizaçao">
            ...
            <p>
              A Casa Irmã Antônia está localizada no endereço: <br />
